...
public class Sample {
	...
	private static final String testFileName = "C:\\Users\\pc\\Desktop\\audio\\1.wav";
	// put your own params here
	private static final String apiKey = "aDMbGya9mZU9CFHrP56S4MLf";// 这里的apiKey就是前面申请在应用卡片中的apiKey
	private static final String secretKey = "5cdeca5413ea8652098be1c8b6d1d522";// 这里的secretKey就是前面申请在应用卡片中的secretKey
	private static final String cuid = "abc";// cuid是设备的唯一标示，因为我用的是PC，所以这里用的是网卡Mac地址
